...
import 'two_winding_defaults.dart';

class TwoWindingDesign {
  TwoWindingDesign._(this._json);

  factory TwoWindingDesign.initial() {
    return TwoWindingDesign._(_cloneMap(kTwoWindingDefaultJson));
  }

  factory TwoWindingDesign.fromJson(Map<String, dynamic> json) {
    return TwoWindingDesign._(_cloneMap(json));
  }
  ...
  Map<String, dynamic> mapAt(String path) {
    final value = readPath(path);
  ...
  TwoWindingDesign copyWithPath(String path, Object? value) {
    final next = toJson();
    _writePath(next, path, value);
    return TwoWindingDesign._(next);
  }

  TwoWindingDesign copyWithJson(Map<String, dynamic> json) {
    return TwoWindingDesign._(_cloneMap(json));
  }
