...
const Map<String, dynamic> kProfileDefaultJson = <String, dynamic>{
...
class ProfileRecord {
  ProfileRecord._(this._json);

  factory ProfileRecord.initial() {
    return ProfileRecord._(_cloneMap(kProfileDefaultJson));
  }

  factory ProfileRecord.fromJson(Map<String, dynamic> json) {
    return ProfileRecord._(_cloneMap(json));
  }
  ...
  ProfileRecord copyWithPath(String path, Object? value) {
    final next = toJson();
    _writePath(next, path, value);
    return ProfileRecord._(next);
  }
