...
class FabricationCalculationResult {
  FabricationCalculationResult._(this._json);

  factory FabricationCalculationResult.fromJson(Map<String, dynamic> json) {
    return FabricationCalculationResult._(_cloneMap(json));
  }
  ...
  FabricationCalculationResult copyWithPath(String path, Object? value) {
    final next = toJson();
    _writePath(next, path, value);
    return FabricationCalculationResult._(next);
  }

  FabricationCalculationResult copyWithJson(Map<String, dynamic> json) {
    return FabricationCalculationResult._(_cloneMap(json));
  }
